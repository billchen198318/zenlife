...
%>
    ...
    <nav class="navbar navbar-expand-md navbar-inverse fixed-top bg-dark">
      ...
      %>
	  <a class="navbar-brand" href="./index-sm.do"><img alt="ZenLife - 禪生活保健" src="./images/logo3.png" border="0"></a>
      <%
      } else {
      %>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="./index-sm.do" onclick=""><b>首頁</b></a>
          </li>              
          <li class="nav-item">
            <a class="nav-link" href="./course-sm.do" onclick=""><b>生活課堂</b></a>
          </li>      
          <li class="nav-item">
            <a class="nav-link" href="./about-sm.do" onclick=""><b>關於</b></a>
          </li>	  
        </ul>
      </div>
    </nav>
