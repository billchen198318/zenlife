...
@Repository("zenlife.dao.ChronicDAO")
public class ChronicDAOImpl extends BaseDAO<ZlChronic, String> implements IChronicDAO<ZlChronic, String> {
	
	public ChronicDAOImpl() {
		super();
	}
