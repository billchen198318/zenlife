...
@Repository("zenlife.dao.CourseReadDAO")
public class CourseReadDAOImpl extends BaseDAO<ZlCourseRead, String> implements ICourseReadDAO<ZlCourseRead, String> {
	
	public CourseReadDAOImpl() {
		super();
	}
